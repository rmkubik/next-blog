...
/**
 * TODO:
 * -X add link buttons to every header
 * -X auto add ids to every header for linking purposes, esp. in markdown
 * -X generate summaries of blog posts
 * -X calculate read times of each post
