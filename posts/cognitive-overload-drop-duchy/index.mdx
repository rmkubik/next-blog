---
title: Cognitive overload in Drop Duchy
date: 2025-05-13
tags: games
---
...
I've been watching [Voyix](https://www.youtube.com/watch?v=yetXqPNbobI) play [Drop Duchy](https://store.steampowered.com/app/2525310/Drop_Duchy/) a bunch since its recent release. It's a really engrossing game. I've noticed some of the mechanics coupled with lack of undo lead to frustrating mistakes. I'm curious to explore that frustration and what might be changed to ease it. I'm not trying to "fix" Drop Duchy, just trying to understand the impact of design decisions.

If you haven't seen it, Drop Duchy is a rouglike where the levels are sort of turn-based Tetris crossed with a tile laying game like Carcassonne. You stack tetromino shaped buildings and terrain on a narrow grid. You're trying to balance completing lines for resources and optimizing your building placements to gain more troops than your enemy.

![Drop Duchy screenshot](./drop-duchy-screenshot.png)

> Drop Duchy game board, late in a round

## Adding complexity to keep turn based interesting
...
In Tetris, all that matters is the position of the piece your placing and how that plays into the next piece and what you have banked. It is very easy to hold all this information in your head (until the game speeds out of your control). You never need to remember that 16 pieces ago you placed an enemy camp that will cause you to lose the round if you align one of your pieces with it later.

Drop Duchy has a lot of pieces like this enemy camp that you just have to try and keep in your mind the whole game. Sometimes a piece placement is trivial, you're just riding out the clock. Sometimes you have to consider how a placement affects 4 or 5 other pieces on the board. It is not always easy to remember which placement is which.
...
I think this comes down to intentionality. If I make the choice to go for a risk I shouldn't have and then it doesn't pay off - that is a good mistake. If I bury an enemy Training Camp in the corner of the map and then at the end of the game forget about it and accidentally align a building with it later, that can feel bad.

Trying to hold a lot of information in my short term memory isn't a challenge I enjoy. When I get punished for failing to do that, I just feel like I made an unintentional mistake. I _intended_ not to align anything with that Training Camp, but I made that intention so long ago I forgot about it entirely. Now I am rudely reminded of failing that intention when my final misplay causes me to go from a victory to a defeat.
...
I think making a mistake like this where you realize "oh shoot, there was no reason to do that". But I was too busy thinking about micro-optimizing some tiny gains and accidentally lost the whole war. As soon as you notice, you'd happily forgo the other stuff you were working on, but you cannot. There's no undo. And even if there were you sometimes don't notice til much later.
...
Drop Duchy being a roguelike can exacerbate the painful feeling of a mistake. Instead of just losing a 10 minute round due to a silly mistake, you have potentially wasted an hour. And then due to the randomnnes, you might never get to try this same scenario out again to learn from it.
...
Because it is harder to order your placement pieces, I'm not sure the Island Maker solution of "only have effects trigger on the piece that is placed" would work as well. It's far more generous in Drop Duchy to allow you to order the pieces in either way.
...
In particular, Drop Duchy doesn't show "current" totals for values that change as the round progresses. I do think this would purely be improve the experience for players. Instead of _only_ computing the strenght of a dynamically computed building at the end of the game, recompute it after each placement. I would imagine this isn't in the game because of a technical limitation vs. an inentional design choice. Who knows though, perhaps the dev prefers the player to try and hold that in their head.

This topic always reminds me of Justin Ma and Matthew Davis talking about how [Into the Breach's interface was a nightmare to make and the key to its greatness](https://www.rockpapershotgun.com/into-the-breach-interface-design).
...
They talk about cutting out otherwise interesting mechanics because they couldn't figure out a way to display them to the player. I don't think this is strictly "better". I think you probably lose out on mechanics that are still interesting to explore even if they have rough edges. How much can you sand those rough edges down before they lose everything that is interesting about them?

## How much can you tweak a game before it becomes something else?

Idk this is really the closing I want to have on the post. But I do feel like I need some sort of closing statement.
