---
title: "Status Code"
description: Status Code is a tactics game made in 13kb about freeing the web from rogue anti virus software.
date: 2020-09-13
thumbnail:
...
The original jam submission was tagged at `1.0.0` on GitHub and clocked in at 13,144 bytes, 168 bytes under budget.
...
🎮 [Play Status Code now!](https://status-code.netlify.app)

<br />

![./status-code-screenshot.png](./status-code-screenshot.png)
